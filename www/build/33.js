...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__billmanagement__ = __webpack_require__(390);
...
BillmanagementPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__billmanagement__["a" /* BillmanagementPage */]),
        ],
    })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng_socket_io__ = __webpack_require__(37);
...
var BillmanagementPage = (function () {
    function BillmanagementPage(viewCtrl, storage, socketHelper, socket, navCtrl, alertCtrl, navParams) {
        var _this = this;
        ...
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        if (item === 'Airtime') {
                            _this.socketHelper.kopaAirtime(data.amount);
                        }
                        else if (item === 'Electricity') {
    ...
    BillmanagementPage.prototype.logOut = function () {
        this.navCtrl.setRoot('WelcomePage');
    };
    BillmanagementPage.prototype.onClose = function () {
